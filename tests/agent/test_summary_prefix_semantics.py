...
_FROZEN_PREFIX_GENERATIONS = (
    # Retired 19 Sep 2026 by the pinned-mandate carve-out: the generation
    # live immediately before SUMMARY_PREFIX started naming
    # '## Standing Mandate (pinned)'.
...
# regression below. Index 2 after the #80622 and pinned-mandate freezes
# were prepended.
