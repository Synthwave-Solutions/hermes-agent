...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "SynthPulse Teal",
  description: "Classic dark teal — the canonical SynthPulse look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "SynthPulse Teal (Large)",
  description: "SynthPulse Teal with bigger fonts and roomier spacing",
